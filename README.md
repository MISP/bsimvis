...
```bash
$ uv run bsim_index.py status <collection_name>
...
```bash
uv run bsim_index.py build <collection_name>
```

To index a specific batch:

```bash
uv run bsim_index.py build <collection_name> --batch <batch_uuid>
```

To rebuild a specific batch:

```bash
uv run bsim_index.py rebuild <collection_name> --batch <batch_uuid>
```
