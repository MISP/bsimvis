...
window.trackLLMBatch = function (jobId, total) {
    ...
    card.style.cssText =
        'background:var(--card-bg); border:1px solid var(--border); border-radius:8px; padding:12px 14px; min-width:260px; font-size:0.8rem; color:var(--fg); box-shadow:0 4px 16px var(--border);';
    card.innerHTML = `
